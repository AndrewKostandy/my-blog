...
Extensions to the techniques shown here can be used to solve other types of problems including Transhipment problems and Shortest Path problems. Additionally, non-linear programming can be used when the objective functions and/or constraints are non-linear.
